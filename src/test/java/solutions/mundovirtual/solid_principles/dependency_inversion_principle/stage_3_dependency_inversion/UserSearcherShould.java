...
final class UserSearcherShould {
    ...
    void find_existing_users() {
        ...
        UsersRepository staffUsersRepository = new StaffUsersRepository();
        UserSearcher userSearcher = new UserSearcher(staffUsersRepository);

        Optional<User> expectedUser = Optional.of(UserMother.obj1());

        assertEquals(expectedUser, userSearcher.search(UserMother.OBJ1_ID));
    }
